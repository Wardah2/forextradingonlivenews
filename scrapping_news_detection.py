...
def predictionBasedOnNews():
    ...
    stocks = ('GOOG', 'AAPL', 'MSFT', 'GME', 'ENGRO','FFC','HBL','PSO','USD/EUR','USD/AED','USD/CAD','USD/GBP')
    ...
    elif selected_stock=='ENGRO':
        csvFilePath_feat = './data/stocks2023/engro_feat.csv'
        df = pd.read_csv(csvFilePath_feat)
        csvFilePath = './data/stocks2023/engro.csv'
        outputCsvPath = './data/stocks2023/engro_feat.csv'
    elif selected_stock=='FFC':
        csvFilePath_feat = './data/stocks2023/ffc_feat.csv'
        df = pd.read_csv(csvFilePath_feat)
        csvFilePath = './data/stocks2023/ffc.csv'
        outputCsvPath = './data/stocks2023/ffc_feat.csv'
    elif selected_stock=='HBL':
        csvFilePath_feat = './data/stocks2023/hbl_feat.csv'
        df = pd.read_csv(csvFilePath_feat)
        csvFilePath = './data/stocks2023/hbl.csv'
        outputCsvPath = './data/stocks2023/hbl_feat.csv'
    elif selected_stock=='PSO':
        csvFilePath_feat = './data/stocks2023/pso_feat.csv'
        df = pd.read_csv(csvFilePath_feat)
        csvFilePath = './data/stocks2023/pso.csv'
        outputCsvPath = './data/stocks2023/pso_feat.csv'
    ...
    def fetch_news(date):
        session = HTMLSession()
        url = f'https://news.yahoo.com{date}'
        r = session.get(url)
